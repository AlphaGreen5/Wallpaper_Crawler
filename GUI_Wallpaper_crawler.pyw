...
class wall_crawler():
    def __init__(self,alpha):
        ...
        """
        self.label4=ttk.Label(alpha,text='Progress :',foreground='red',font=('arial',8))
        self.label4.place(x=5,y=190)

        self.label5=ttk.Label(alpha,text='Overall Progress :',foreground='red',font=('arial',8))
        self.label5.place(x=5,y=220)
"""
        ...
        self.button1=ttk.Button(alpha,text='Download',command=lambda:start())
        self.button1.place(x=230,y=110)

        
        """
        #progressbar
        self.progress=ttk.Progressbar(alpha,length=200,maximum=20,mode='determinate',orient=HORIZONTAL)
        self.progress.place(x=100,y=190)
        self.progress1=ttk.Progressbar(alpha,length=200,maximum=20,mode='determinate',orient=HORIZONTAL)
        self.progress1.place(x=100,y=220)
"""
